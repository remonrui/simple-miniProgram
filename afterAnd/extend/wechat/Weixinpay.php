...
class Weixinpay {
    ...
    private $config=array(
        ...
        'NOTIFY_URL'         => 'http://lh.0571ztnet.com/index/wechat/notify', // 接收支付状态的连接  改成自己的域名
        );
    ...
    public function unifiedOrder($order){
        ...
        $nonce_str = strtoupper(md5(mt_rand(1,100)));
...
//        $url = 'https://api.mch.weixin.qq.com/sandboxnew/pay/unifiedorder';  //仿真测试
